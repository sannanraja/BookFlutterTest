import 'package:bookflutter/uiscreens/fourth_route.dart';
...
class Detail extends StatelessWidget {
    ...
    final appBar = AppBar(
      ...
      title: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Please Enter Book name to see Order of Books',
          )),
      actions: <Widget>[
        IconButton(
          icon: Icon(Icons.add),
          onPressed: () {
            bookscollection.add({'name': textController.text});
  ...
  void CreateUser({required String name}) async {
    ...
    final docuser =
        FirebaseFirestore.instance.collection('books').doc('CreatedbySanan');
    // final json = {
    //   "name": name,
    //   "email": "john@example.com"
    // };
